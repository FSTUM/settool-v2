    ...
    path(
        ...
        include(
            [
                ...
                path("view/<uuid:tour_pk>/", views.view_tour, name="view_tour"),
                path("edit/<uuid:tour_pk>/", views.edit_tour, name="edit_tour"),
                path("delete/<uuid:tour_pk>/", views.del_tour, name="del_tour"),
                path("export/<str:file_format>/<uuid:tour_pk>/", views.export_tour, name="export_tour"),
            ],
        ),
    ),
    path(
