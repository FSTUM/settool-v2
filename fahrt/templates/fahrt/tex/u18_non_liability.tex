...
\begin{Form}
    ...
    \end{longtable}
    {% include "tex/signature.tex" with from="eines Erziehungsberechtigen" id=1 %}
    ...
    \\
    {% include "tex/signature.tex" with from="eines Erziehungsberechtigen" id=2 %}
    ...
    \\
    {% include "tex/signature.tex" with from="der Aufsichtsperson" id=3 %}
\end{Form}
{% endblock %}
