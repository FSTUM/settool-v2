...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='semester',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fahrt_participant', to='settool_common.Semester'),
        ),
        migrations.AlterField(
            model_name='participant',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fahrt_participant', to='settool_common.Subject', verbose_name='Subject'),
        ),
    ]
